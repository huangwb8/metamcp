  ...
  async findByUuidWithServers(
    ...
    const serversData = await db
      .select({
        ...
        last_health_check_at: mcpServersTable.last_health_check_at,
        last_health_check_error: mcpServersTable.last_health_check_error,
        last_health_check_latency_ms:
          mcpServersTable.last_health_check_latency_ms,
